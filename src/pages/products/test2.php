<?php
#zigg:title       = `Test 2`
#zigg:page-title  = `Test 2`
#zigg:slug        = `test-2`
#zigg:parent      = `products`
#zigg:logo        = `assets/images/products/stork-logo.svg`
#zigg:cover-image = `_cover-stork{$size}.png`
#zigg:cover-alt   = `Stork logo`
#zigg:date        = ``
#zigg:description = `WordPress secure file uploads and management made easy.`
#zigg:priority    = `0.5`
?>
<section class="page-section">
  <div class="wrap">
    <h1 class="page-title">Stork</h1>
    <h2>WordPress secure file uploads and management made easy.</h2>
  </div>
