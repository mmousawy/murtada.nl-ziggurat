...
<section class="page-section">
  <div class="wrap">
    <h1 class="page-title">Stress in Action</h1>
  </div>
  ...
  <div class="content-row">
    <div class="wrap">
      ...
      <div class="content-row__text">
        <p>Stress in Action needed a website to present the project to its audience: universities, professors and scientists. There was a lot of information to convey that needed to be separated in a clear way.</p>
        <p>Most of the textual content was already finished, but the content was not separated in different sections. The word-heavy content also needed something visually appealing to keep the reader interested.</p>
      </div>
    </div>
  </div>
    ...
    <div class="wrap">
      ...
      <div class="content-row__text">
        ...
        <figure class="picture-wrapper">
          ...
          <figcaption class="picture-wrapper__caption">Quick sketch of the Stress in Action website sitemap.</figcaption>
        </figure>
        ...
        <p>We did notice there was still a lot of text visible on every page. It looked like a massive wall of text. We were afraid that it might be a moment for the reader to give up on actually reading the text. So we decided to visually organise the visible text in manageable chunks with a clear title for the reader to open. This way, you can quickly skim through the topics of the text without having to scroll at all.</p>
        ...
        <p>Scalable vector graphics (SVG) are a perfect fit for this illustration style because all the shapes are based on mathematical coordinates and the image stays clear on any size.</p>
      </div>
    </div>
  </div>
  ...
  <div class="content-row">
    <div class="wrap">
      ...
      <div class="content-row__text">
        <p>Having to present a lot of text to any audience may seem daunting. Making the choice to visually limit the amount of text on pages with lots of context is an easy fix. By packaging the website in a visually appealing aesthetic, you will make the experience more pleasurable.</p>
        <p>All this effort is in the end worth it: your audience will actually invest their time in reading what you have to say.</p>
      </div>
    </div>
  </div>
