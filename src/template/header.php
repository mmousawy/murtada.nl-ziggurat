<?php
  ...
  $coverImage = $Ziggurat->searchPage('index')['properties']['cover-image']['url'];

  if (isset($props['cover-image']['url'])) {
    $coverImage = $props['cover-image']['url'];
  } else if (isset($props['cover-image']['large']['url'])) {
    $coverImage = $props['cover-image']['large']['url'];
  }
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <meta property="og:image" content="https://murtada.nl/<?= $coverImage ?>">
  ...
  <meta name="twitter:image" content="https://murtada.nl/<?= $coverImage ?>">
